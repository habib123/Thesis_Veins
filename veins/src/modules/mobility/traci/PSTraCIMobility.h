 ...
 */
namespace Veins {
class PSTraCIMobility : public BaseMobility
{
	public:
		class Statistics {
			public:
		...
		PSTraCIMobility() : BaseMobility(), isPreInitialized(false) {}
...
{
	public:
		PSTraCIMobility* get(cModule* host) {
			PSTraCIMobility* traci = FindModule<PSTraCIMobility*>::findSubModule(host);
			ASSERT(traci);
			return traci;
		};
};
